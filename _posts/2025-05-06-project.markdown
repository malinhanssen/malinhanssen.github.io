...
These contrasts were visualized using targeted plots, which made the distinctions between the two groups more interpretable. The findings provided a foundation for further analysis, including clustering and feature importance modeling.
